 ...
 * word should have the beginning of the first word and the ending of the second, with the
...
function stringMerge($string1, $string2, $letter):string {
    $firstPart = strstr($string1, $letter, true);
    $secondPart = substr($string2, strpos($string2, $letter));
    return $firstPart.$secondPart;
}


echo stringMerge("person","here", "e");