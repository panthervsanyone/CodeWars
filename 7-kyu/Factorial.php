...
IllegalArgumentException (Java) or RangeException (PHP) or throw a RangeError (JavaScript) or ValueError
 (Python) or return -1 (C).
 */
function factorial(int $n): int
{
    if ($n < 0 || $n > 12) {
        throw new RangeException("Range must be between 0 and 12");
    }
    $factor = range(1, $n);
